    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
        {scrolled && (
          <button 
            onClick={scrollToTop} 
            className="w-12 h-12 rounded-full btn-premium-secondary flex items-center justify-center animate-[fade-in-up_0.3s_ease-out] shadow-lg" 
            title={t.goToTop}
        ...
        <a 
          href="https://wa.me/qr/PVGBWSHZLQEVN1" 
          target="_blank" 
          rel="noopener noreferrer"
          className="w-12 h-12 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300 animate-[fade-in-up_0.4s_ease-out]" 
        ...
        {averageRatingInfo.count > 0 && (
          <button ref={ratingButtonRef} onClick={handleRatingButtonClick} className="py-2 px-4 rounded-full text-sm font-bold btn-premium-secondary flex items-center gap-2 shadow-lg" title={t.viewRating}>
