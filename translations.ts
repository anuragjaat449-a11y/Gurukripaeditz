export const translations = {
  en: {
    ...
    playVideoAria: "Play Video {videoNumber} in the app",
    youTubePlayerTitle: "YouTube player for Video {videoNumber}",
  ...
  hi: {
    ...
    playVideoAria: "ऐप में वीडियो {videoNumber} चलाएं",
    youTubePlayerTitle: "वीडियो {videoNumber} के लिए यूट्यूब प्लेयर",
